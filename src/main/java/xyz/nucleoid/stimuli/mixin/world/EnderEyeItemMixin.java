...
public class EnderEyeItemMixin {
    ...
    private BlockPattern.BlockPatternMatch searchAround(BlockPattern instance, LevelReader worldView, BlockPos pos, Operation<BlockPattern.BlockPatternMatch> original, @Local(argsOnly = true) UseOnContext context) {
